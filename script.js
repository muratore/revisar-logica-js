...
const weekDay = new Date(); // instancia a classe date do javascripte
const today = weekDay.getDay(); //retorna um número de 0 a 6 correspondendo o dia da semana dinamicamente
...
console.log(
  `O ítem removido ${removeElement} estava na posição ${list.indexOf(
    removeElement
  )}`
);
